...
class Blog_model extends CI_Model
{
	...
	public function tkt_get_list($limit=0,$offset=0,$order='DESC',$fieldoder='',$blogcat_id=0)
	{
		if($limit!=0)
		{
		...
		$this->db->join('users','user_id=blog_user_id');
		if($blogcat_id!=0) $this->db->like("blog_cat_ids","\"".$blogcat_id."\"");
