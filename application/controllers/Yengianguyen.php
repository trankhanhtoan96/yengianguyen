...

{
...

	{
		...
		$data['SEO_keyword'] = $data['_varibles']['product_category']['product_category_seo_keyword'];

		$data['SEO_descriptiton'] = $data['_varibles']['product_category']['product_category_seo_description'];
...

	{
		...
		$data['SEO_keyword'] = $data['_varibles']['product']['product_seo_keyword'];

		$data['SEO_descriptiton'] = $data['_varibles']['product']['product_seo_description'];

		$data['SEO_image'] = $data['_varibles']['product']['product_image'];
