				...
				<form action="" method="post" class="form-horizontal form-label-left">
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input maxlength="20" type="text" id="old_password" class="form-control col-md-7 col-xs-12" name="old_password" required="required" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input maxlength="20" type="text" id="new_password" class="form-control col-md-7 col-xs-12" name="new_password" required="required" />
						</div>
					</div>
