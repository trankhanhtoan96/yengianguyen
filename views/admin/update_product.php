      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
         ...
         <div class="x_panel">
            ...
            <div class="x_content">
               ...
               <a href="/admin/product" class="btn btn-danger" data-toggle="tooltip" title="trở lại"><i class="fa fa-reply"></i></a>

               <button type="submit" class="btn btn-success" data-toggle="tooltip" title="lưu cập nhật"><i class="fa fa-floppy-o"></i></button>
            ...
            <div class="x_content">
               ...
               <div class="form-group hidden">
                  ...
                  <div class="col-md-10 col-sm-10 col-xs-12">
                     ...
                     <input type="number" id="product_price_in" class="form-control col-md-7 col-xs-12" value="<?=$product['product_price_in']?>" name="product_price_in"/>
               ...
               <div class="form-group">
                  ...
                  <div class="col-md-10 col-sm-10 col-xs-12">
                     ...
                     <input type="number" id="product_price_out" class="form-control col-md-7 col-xs-12" value="<?=$product['product_price_out']?>" name="product_price_out"  />
